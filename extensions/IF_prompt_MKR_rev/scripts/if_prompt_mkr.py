...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        with gr.Accordion('Styling(Optional)', open=False):
            with gr.Group():
                with gr.Row():
                    with gr.Column(scale=1, min_width=100):
        ...
        with gr.Accordion('Prefix & TIembeddings', open=False):
            ti_choices = ["None"]
        ...
        with gr.Accordion('Suffix & Loras', open=False):
            lora_choices = ["None"]
        ...
        with gr.Accordion('Vision MultiModal', open=False):
            with gr.Group():
                with gr.Row():
